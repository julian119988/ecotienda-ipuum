...
export default function Historial() {
    ...
    const historialFormateado = () => {
        ...
        setFormattedHistory(arrayOrdenado.reverse());
    };
    return (
        <Main>
            <FiltrosDiv>
            ...
            {!formattedHistory[0] ? (
                ...
                formattedHistory.map((elemento, index) => {
                    let mes;
                    if (index === 0) mes = "Enero";
                    if (index === 1) mes = "Febrero";
                    if (index === 2) mes = "Marzo";
                    if (index === 3) mes = "Abril";
                    if (index === 4) mes = "Mayo";
                    if (index === 5) mes = "Junio";
                    if (index === 6) mes = "Julio";
                    if (index === 7) mes = "Agosto";
                    if (index === 8) mes = "Septiembre";
                    if (index === 9) mes = "Octubre";
                    if (index === 10) mes = "Noviembre";
                    if (index === 11) mes = "Diciembre";
                    if (!elemento[0]) {
                        return "";
                    }
                    return (
